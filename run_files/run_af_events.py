from af_tokens import token_tezbol, id_andr_tezbol, id_andr_kreditomat_kz, token_kreditomat_kz
...
if __name__ == '__main__':
    ...
    print(AF_events_data(app_id, token, to_date, from_date).get_sumbit_cuID())